...
activities = {
    ...
    "Swimming Club": {
        "description": "Swimming training for all levels with lap practice and drills",
    ...
    "Debate Team": {
        "description": "Practice public speaking, argumentation, and competitive debate skills",
